...
$query=$conn->query("INSERT INTO upload1 (name,date) VALUES ('$name','$date')");
if($query){
...
#photo
{
   ...
   font-size: 20px;
      ...
      <a href="welcome_admin.php" class="btn btn-warning" style="padding: 10px; width: 80px; left: 20px;"> Go Back </a>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<th>Remove</th>
                            ...
                            <tbody>
							<?php 
							$query=mysqli_query($conn,"select * from upload1 ORDER BY id DESC")or die(mysqli_error($conn));
